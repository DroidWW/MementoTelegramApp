...
public class OnlineGame1 : MonoBehaviour
{
    ...
    void StartGame()
    {
        ...
        ResetButtonColor();
        StartCoroutine(Timer(NumberTimer));
    ...
    IEnumerator Timer(int numberTimer)
    {
        ...
        {
            OtherObjects[4].GetComponent<TextMeshProUGUI>().text = numberTimer.ToString();
    ...
    void SetAfterGameWindow()
    {
        ...
        OtherObjects[1].GetComponent<TextMeshProUGUI>().text = "Sequence memory";
    }
